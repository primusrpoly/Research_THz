...
with pd.ExcelWriter(file_path, mode='a', engine='openpyxl') as writer:
    df_metrics.to_excel(writer, sheet_name='KNN_SMAPE2', index=False, startrow=0, startcol=0)
    df_metrics_a20.to_excel(writer, sheet_name='KNN_A202', index=False, startrow=0, startcol=0)
