...
with pd.ExcelWriter(file_path, mode='a', engine='openpyxl') as writer:
    df_metrics.to_excel(writer, sheet_name='ABR1234567', index=False, startrow=0, startcol=0)
    # df_selected_features.to_excel(writer, sheet_name='SVRFeats1234567', index=False)