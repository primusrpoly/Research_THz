...
# Predict and evaluate using MSE and A20 accuracy
...
# Define optimal parameters search function
def find_optimal_parameters(phase_noise_value):
    
    def round_to_nearest_5(value):
        return round(value * 2) / 2

    # Symbol rate limits based on phase noise
    ...
    #slight increase to snr for higher pn levels, can stay fixed if needed
    ...
    # Predict BER using rounded values
    ...
    # Differential evolution with custom rounding
    def de_objective(params):
        rounded_params = [
            ...
            round_to_nearest_5(params[3])                    # SNR (integer))
        ]
