...
column_names = ['PilotLength', 'PilotSpacing', 'SymbolRate', 'PhaseNoise', 'SNR', 'BER', 'OBER']
...
def find_optimal_parameters(phase_noise_value):
    ...
    bounds = [(phase_noise_value, phase_noise_value), (8, 64), (32, 1024), (1e6, 3e10), (1, 100)]
