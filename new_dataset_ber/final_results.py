...
with pd.ExcelWriter(file_path, mode='a', engine='openpyxl') as writer:
    df_metrics_SMAPE.to_excel(writer, sheet_name='15ABR_Final_SMAPE', index=False, startrow=0, startcol=0)
    df_metrics_A20.to_excel(writer, sheet_name='15ABR_Final_A20', index=False, startrow=0, startcol=0)
    df_metrics_MAE.to_excel(writer, sheet_name='15ABR_Final_MAE', index=False, startrow=0, startcol=0)